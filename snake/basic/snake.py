...
from snake.basic.point import PointType
...
class Snake:
    ...
    def __init__(self, m, init_direc = None, init_bodies = None, init_types = None):
        ...
        Args:
            m (basic.map.Map): The map that the snake moves on.
            init_direc (basic.direc.Direc): Initial direction.
            init_bodies (list of basic.pos.Pos): Initial snake bodies positions.
            init_types (list of basic.point.PointType): Types of each position in init_bodies.
        """
        self.__map = m;
    ...
    def reset(self, reset_map = True):
        ...
        if rand_init:
            self.__init_direc = self.init_bodies = self.__init_types = None
    
    def copy(self):
        m_copy = self.__maap.copy()
